# Kingdom Battlegound Game System

![Foundry v11](https://img.shields.io/badge/foundry-v11-green)

This system is a kingdom-battleground system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the Kingdom system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-kingdom-battleground-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `kingdom-battleground` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `kingdom-battleground` and `Kingdom` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Kingdom System](https://gitlab.com/asacolips-projects/foundry-mods/vue3kingdom-battleground) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/kingdom-battleground.png)
